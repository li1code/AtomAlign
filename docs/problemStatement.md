...
9.  Live / hosted demo URL of the portal
10. Source code repository (GitHub / GitLab / Bitbucket)
11. Architecture diagram (PDF or image)
12. Login credentials of the 3 roles (Employee, Manager, Admin) or option to switch between user journeys
